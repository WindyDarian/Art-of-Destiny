...
namespace CombatLibrary.Spells
{
    ...
    public class SpaceGrip : Skill
    {
        ...
        public override void SkillAction()
        {
            ...
            Target.GetDamage(Damage.CreateFromDamage(Damage, MargedUnit));
            if (Target.Position != MargedUnit.Position)
            {
                Target.GetImpulse(FloatValues[0] * Vector3.Normalize(MargedUnit.Position - Target.Position));//造成冲量，拉近
