...
namespace CombatLibrary.Spells
{
    ...
    public class Summon : Skill
    {
        ...
        {
            GameWorld.CreateNPCUnit(GameWorld.Content.Load<UnitType>(UnitAssetName), MargedUnit.Group, MargedUnit.Position + AODGameLibrary.Helpers.RandomHelper.RandomDirection() * SummonRange);
        }
        /// <summary>
        /// Update时的动作
        /// </summary>
