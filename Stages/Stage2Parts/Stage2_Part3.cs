...
namespace Stages.Stage2Parts
{
    ...
    public class Stage2_Part3 : StagePart
    {
        ...
        public override void Initialize()
        {
            ...
            Stage.AddGameMessage(@"杰诺：我讨厌这鬼地方。", Color.LightGreen, 2);
            Stage.AddGameMessage(@"阿莉西亚：……杰诺，还有比尔，你们能听到吗？一切正常？", Color.Yellow, 3);
            Stage.AddGameMessage(@"杰诺：在本游侠的处理下，一切太正常不过了。", Color.LightGreen, 3);
            Stage.AddGameMessage(@"阿莉西亚：太好了！", Color.Yellow, 3);
            Stage.AddGameMessage(@"比尔：女士，我不知道你是如何做到在这么远的距离使声音如此清楚。", Color.CornflowerBlue, 4);
            Stage.AddGameMessage(@"比尔：我必须怀疑……", Color.CornflowerBlue, 4);
            Stage.AddGameMessage(@"阿莉西亚：怀疑吗……你们当然有权利怀疑我……", Color.Yellow, 3);
            Stage.AddGameMessage(@"杰诺：但不得不说如果没有你，我们已经死光了。", Color.LightGreen, 3);
            Stage.AddGameMessage(@"杰诺：所以，你有本游侠的……感谢。", Color.LightGreen, 3);
            Stage.AddGameMessage(@"杰诺：比尔，她是阿莉西亚，刚才那个对付那个大家伙也有一部分她的功劳。", Color.LightGreen, 3);
            Stage.AddGameMessage(@"比尔：好吧，我现在暂时相信你，女士。", Color.CornflowerBlue, 4);
            Stage.AddGameMessage(@"比尔：盖亚号，比尔正在呼叫，请作出回应。", Color.CornflowerBlue, 4);
            ...
            Stage.AddGameMessage(@"杰诺：我是他朋友？", Color.LightGreen, 3);
            Stage.AddGameMessage(@"比尔：威克多，我们正准备突破最近的星门，我们需要一个回到休斯星域的坐标。", Color.CornflowerBlue, 4);
            Stage.AddGameMessage(@"威克多：不，我们会给你提供另一个坐标。", Color.Yellow, 4);
            Stage.AddGameMessage(@"杰诺：什么？", Color.LightGreen, 2);
            Stage.AddGameMessage(@"威克多：我们打算直接进攻秩序之眼的核心，“遗迹”将是这个计划必不可少的东西。", Color.Yellow, 4);
            Stage.AddGameMessage(@"杰诺：好吧，那么“遗迹”有什么用？", Color.LightGreen, 2);
            ...
            Stage.AddGameMessage(@"杰诺：然后程序出了BUG，对吧？", Color.LightGreen, 2);
            ...
            Stage.AddGameMessage(@"杰诺：听起来很美。", Color.LightGreen, 2);
            ...
            Stage.AddGameMessage(@"威克多：不要让我再次失望，比尔.沃顿。", Color.Yellow, 4);
            Stage.AddGameMessage(@"…………", Color.White, 3);
            Stage.AddGameMessage(@"阿莉西亚：嘿，这个指挥官疯了吗？", Color.Yellow, 4);
            Stage.AddGameMessage(@"比尔：虽然我不知道细节，但这个行动简直是以卵击石。", Color.CornflowerBlue, 4);
            Stage.AddGameMessage(@"比尔：杰诺，我们能够做到，至少能够突破星门。", Color.CornflowerBlue, 4);
            Stage.AddGameMessage(@"比尔：突破星门之后，你有两个选择。", Color.CornflowerBlue, 4);
            Stage.AddGameMessage(@"比尔：其一是，如果你想活下去，你可以在星门那边把“遗迹”交给我。", Color.CornflowerBlue, 4);
            Stage.AddGameMessage(@"比尔：然后我会派人护送你安全返回。而第二个选择……", Color.CornflowerBlue, 4);
            Stage.AddGameMessage(@"杰诺：那么，我选第二个。", Color.LightGreen, 2);
            Stage.AddGameMessage(@"阿莉西亚：杰诺，真的吗？你会为了与自己毫不相干的东西而战斗下去？", Color.Yellow, 4);
            Stage.AddGameMessage(@"阿莉西亚：或许只是因为好奇着，只是因为期待着吧。", Color.Yellow, 4);
            Stage.AddGameMessage(@"阿莉西亚：但你还是选择了自己的路。", Color.Yellow, 3);
            Stage.AddGameMessage(@"比尔：看来你已经决定好了，杰诺。那么，我们前进吧。", Color.CornflowerBlue, 4);
