...
namespace Stages.Stage2Parts
{
    ...
    public class Stage2_Part4 : StagePart
    {
        ...
        public override void Initialize()
        {
            ...
            Stage.AddGameMessage(@"杰诺：上膛吧。", Color.LightGreen, 3);
            Stage.AddGameMessage(@"克雷斯：异教徒们，别太嚣张了，你们的一举一动完全在教会的掌握之中！", Color.Red, 4);
            Stage.AddGameMessage(@"克雷斯：没有任何仁慈，神将赐予你们同等的毁灭。", Color.Red, 4);
            Stage.AddGameMessage(@"克雷斯：我，黑骑士，就在星际的门口恭候你们的光临，而且……你们被包围了。", Color.Red, 8);
            t1 = Stage.CreateTimer(2);
            Stage.AddGameMessage(@"比尔：克雷斯？他是个危险的家伙，一切必须小心。", Color.CornflowerBlue, 4);
            Stage.AddGameMessage(@"阿莉西亚：小心了，敌人正源源不断地从那个星际之门涌出来。", Color.Yellow, 3);
